			...
			<div className="moreInfoWrapper">
				...
				<div className="moreInfoCenter">
					...
					<div className="productFullInfo">
						<ul className="fullInfoLeft">
							<li className="proInfoName">Бренд</li>
							<li className="proInfoName">Для кого</li>
							<li className="proInfoName">Тип флакона</li>
							<li className="proInfoName">Ароматы</li>
						</ul>

						<ul className="fullInfoRight">
							<li className="proInfoDesc">Moschino</li>
							<li className="proInfoDesc">Для женщин</li>
							<li className="proInfoDesc">Спрей</li>
							<li className="proInfoDesc">Цитрусовый, цветочный, древесный</li>
						</ul>
					</div>
				</div>
